...
<script type="text/javascript">
    $(document).ready(() => {
        ...
        $(document).on('submit', '#formData', function(e) {
            ...
            loadingScreenOn();
            let req = requestAjax('<?= site_url('study_program/submit_data') ?>', `${$(this).serialize()}&submit_action=${SUBMIT_ACTION}`);
            req.done((res) => {
                if (res.success) {
        ...
        $(document).on('submit', '#formDelete', function(e) {
            ...
            loadingScreenOn();
            let req = requestAjax('<?= site_url('study_program/delete_data') ?>', $(this).serialize());
            req.done((res) => {
                if (res.success) {
                    reloadDatatable('#tblData');
    ...
    function loadTable() {
        let tblData = $('#tblData').datatable({
            url: "<?= site_url('study_program/load_table') ?>",
